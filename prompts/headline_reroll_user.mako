Target date: ${today_iso}.

Eligible topics (pick ONE story from any of these):
${eligible_titles_bullets}

Rules:
  - The body covers ONE story only. No "in other news", no "meanwhile".
  ...
  - Do NOT supply image URLs anywhere.
